...
//pegar um livro
server.get('/livro/:codigo', async (req: Request, res: Response): Promise<Response> => 
{
...
//gravar livro
server.post('/livro', async (req: Request, res: Response): Promise<Response> => 
{
    let livro = new Livro();
...
//editar livro
server.put('/livro/:codigo', async (req: Request, res: Response): Promise<Response> => 
{
    let codigo = Number(req.params.codigo);
...
server.delete('/livro/:codigo', async (req: Request, res: Response): Promise<Response> => 
{
    let codigo = Number(req.params.codigo);
...
server.get('/livro/:codigo/emprestar', async (req: Request, res: Response): Promise<Response> => 
{
    let codigo = Number(req.params.codigo);
...
server.get('/livro/:codigo/devolver', async (req: Request, res: Response): Promise<Response> => 
{
    let codigo = Number(req.params.codigo);
